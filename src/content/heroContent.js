export const hero = {
  ...
  links: [
    ...
    { label: "Instagram", href: "#", class: "hover:text-pink-400 transition" },
    { label: "Gumroad", href: "#", class: "hover:text-green-400 transition" },
    { label: "Email", href: "#", class: "hover:text-yellow-400 transition" }
  ]
}; 